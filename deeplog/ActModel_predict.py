...
if __name__ == '__main__':
    ...
    num_classes = 28
    input_size = 1
    model_path = r'E:\code\deeplog\model\Adam_batch_size=1024_epoch=300.pt'
    ...
    # test_normal_loader = generate(r'E:\code\祝贺论文相关\act-Classification\data\httpreduce_n.csv')
    # test_abnormal_loader = generate(r'E:\code\祝贺论文相关\act-Classification\data\httpreduce_an.csv')
    test_normal_loader = generate(r'E:\code\deeplog\data\hdfs_test_normal_mini')
    test_abnormal_loader = generate(r'E:\code\deeplog\data\hdfs_test_abnormal')
    TP = 0
    FP = 0
    # Test the model
    ...
    with torch.no_grad():
        for line in test_normal_loader:
            ...
            for i in range(window_size,len(line) - window_size):
                ...
                label = line[i]
                seq = torch.tensor(seq, dtype=torch.float).view(-1, window_size*2, input_size).to(device)
